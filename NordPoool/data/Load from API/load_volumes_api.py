...
def volumes_json_to_long_dataframe(data):
...
print("\n====================================")
print("DESCARGA NORD POOL VOLUMES")
print("====================================")
...
try:
    ...
    for day in daterange(
        ...
        try:
            ...
            # JSON -> DATAFRAME
            df_day = (
                volumes_json_to_long_dataframe(
                    data
                )
            )
